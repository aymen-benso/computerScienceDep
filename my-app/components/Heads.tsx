...
export default function Heads() {
  ...
  <div
    className="bg-gray-100 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-4 transition-all duration-500 transform">
    <div className="flex items-center gap-4">
      <img src="https://365healthservices.com/wp-content/uploads/2023/09/smiling-mature-african-american-man-768x475.webp"
    ...
    />
      <div className="w-fit transition-all transform duration-500">
        ...
        <p className="text-gray-400">Chef Department</p>
        <a
